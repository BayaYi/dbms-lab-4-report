...
Write Ahead Log (WAL) İlkesiBir veritabanı için en maliyetli ve riskli işlem "yazma" işlemidir. Bir veri güncellendiğinde, verinin asıl dosyasının (data file) rastgele bir konumuna gidip yazmak çok yavaştır. Bunun yerine WAL mekanizması devreye girer.
